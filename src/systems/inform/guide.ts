...
export const guide: SystemGuide = {
  ...
  auth: 'Token',
  examples: [
    { id: 'getForms', method: 'GET', path: '/forms', label: 'List deployed forms' },
    { id: 'getForm', method: 'GET', path: '/forms/6225', label: 'Fetch a form by id' },
    { id: 'getSubs', method: 'GET', path: '/data/6225', label: 'List submissions for a form' },
    { id: 'getSub', method: 'GET', path: '/data/6225/7783155', label: 'Fetch a submission by id' },
    { id: 'media', method: 'GET', path: '/media/621985', label: 'Fetch attachment metadata' },
  ],
};
