...
export const usage: UsageExample[] = [
  ...
  { fn: "upsertLocation", signature: "upsertLocation(externalId, goDataLocation, callback?)", description: "Create or update a location, deduplicating on the named field (its value must be in the data).",
    code: "upsertLocation('id', { id: 'LOC-FREETOWN', name: 'Freetown' });" },
  ...
  { fn: "upsertReferenceData", signature: "upsertReferenceData(externalId, goDataReferenceData, callback?)", description: "Create or update a reference-data entry, deduplicating on the named field (its value must be in the data).",
    code: "upsertReferenceData('id', {\n  id: 'LNG_REFERENCE_DATA_CATEGORY_RISK_LEVEL_LOW', categoryId: 'LNG_REFERENCE_DATA_CATEGORY_RISK_LEVEL', value: 'Low',\n});" },
];
