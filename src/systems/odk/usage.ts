...
export const usage: UsageExample[] = [
  ...
  { fn: "post", signature: "post(path, body, options = {})", description: "Make a POST request against the ODK Central server — here, commenting on a submission.",
    code: "post('v1/projects/1/forms/household-survey/submissions/uuid:sub-0001/comments', {\n  body: 'Checked against the paper form.'\n});", apiRef: "comment" },
